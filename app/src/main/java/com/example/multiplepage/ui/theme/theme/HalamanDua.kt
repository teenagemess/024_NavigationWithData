...
fun HalamanDua(
    ...
    val items = listOf(
        Pair(stringResource(R.string.nama), orderUIState.jumlah),
        Pair(stringResource(R.string.alamat), orderUIState.jumlah),
        Pair(stringResource(R.string.nohp), orderUIState.jumlah),
